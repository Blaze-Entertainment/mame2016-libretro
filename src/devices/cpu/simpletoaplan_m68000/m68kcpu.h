...
class simpletoaplan_m68000_base_device;
...
#define CPU_TYPE_SIMPLETOAPLAN_FSCPU32  (0x00000800)
...
#define SIMPLETOAPLAN_M68K_CACR_IBE 0x10 // Instruction Burst Enable
#define SIMPLETOAPLAN_M68K_CACR_CI  0x08 // Clear Instruction Cache
#define SIMPLETOAPLAN_M68K_CACR_CEI 0x04 // Clear Entry in Instruction Cache
#define SIMPLETOAPLAN_M68K_CACR_FI  0x02 // Freeze Instruction Cache
#define SIMPLETOAPLAN_M68K_CACR_EI  0x01 // Enable Instruction Cache
...
#define CPU_TYPE_IS_020_PLUS(A)    ((A) & (CPU_TYPE_020 | CPU_TYPE_030 | CPU_TYPE_EC030 | CPU_TYPE_040 | CPU_TYPE_EC040 | CPU_TYPE_SIMPLETOAPLAN_FSCPU32 | CPU_TYPE_COLDFIRE))
#define CPU_TYPE_IS_020_LESS(A)    1

#define CPU_TYPE_IS_020_VARIANT(A) ((A) & (CPU_TYPE_EC020 | CPU_TYPE_020 | CPU_TYPE_SIMPLETOAPLAN_FSCPU32))

#define CPU_TYPE_IS_EC020_PLUS(A)  ((A) & (CPU_TYPE_EC020 | CPU_TYPE_020 | CPU_TYPE_030 | CPU_TYPE_EC030 | CPU_TYPE_040 | CPU_TYPE_EC040 | CPU_TYPE_SIMPLETOAPLAN_FSCPU32 | CPU_TYPE_COLDFIRE))
#define CPU_TYPE_IS_EC020_LESS(A)  ((A) & (CPU_TYPE_000 | CPU_TYPE_008 | CPU_TYPE_010 | CPU_TYPE_EC020))

#define CPU_TYPE_IS_010(A)         ((A) == CPU_TYPE_010)
#define CPU_TYPE_IS_010_PLUS(A)    ((A) & (CPU_TYPE_010 | CPU_TYPE_EC020 | CPU_TYPE_020 | CPU_TYPE_EC030 | CPU_TYPE_030 | CPU_TYPE_040 | CPU_TYPE_EC040 | CPU_TYPE_SIMPLETOAPLAN_FSCPU32 | CPU_TYPE_COLDFIRE))
...
#define simpletoaplan_m68ki_exception_if_trace(m68k) if(m68k->tracing) simpletoaplan_m68ki_exception_trace(m68k)
...
class simpletoaplan_m68000_base_device_ops
{
public:
...
extern const UINT8    simpletoaplan_m68ki_shift_8_table[];
extern const UINT16   simpletoaplan_m68ki_shift_16_table[];
extern const UINT32   simpletoaplan_m68ki_shift_32_table[];
extern const UINT8    simpletoaplan_m68ki_exception_cycle_table[][256];
extern const UINT8    simpletoaplan_m68ki_ea_idx_cycle_table[];

/* Read data immediately after the program counter */
static inline UINT32 m68ki_read_imm_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 m68ki_read_imm_32(simpletoaplan_m68000_base_device *m68k);

/* Read data with specific function code */
static inline UINT32 m68ki_read_8_fc  (simpletoaplan_m68000_base_device *m68k, UINT32 address, UINT32 fc);
static inline UINT32 m68ki_read_16_fc (simpletoaplan_m68000_base_device *m68k, UINT32 address, UINT32 fc);
static inline UINT32 m68ki_read_32_fc (simpletoaplan_m68000_base_device *m68k, UINT32 address, UINT32 fc);

/* Write data with specific function code */
static inline void m68ki_write_8_fc (simpletoaplan_m68000_base_device *m68k, UINT32 address, UINT32 fc, UINT32 value);
static inline void m68ki_write_16_fc(simpletoaplan_m68000_base_device *m68k, UINT32 address, UINT32 fc, UINT32 value);
static inline void m68ki_write_32_fc(simpletoaplan_m68000_base_device *m68k, UINT32 address, UINT32 fc, UINT32 value);
static inline void m68ki_write_32_pd_fc(simpletoaplan_m68000_base_device *m68k, UINT32 address, UINT32 fc, UINT32 value);

/* Indexed and PC-relative ea fetching */
static inline UINT32 m68ki_get_ea_pcdi(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 m68ki_get_ea_pcix(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 m68ki_get_ea_ix(simpletoaplan_m68000_base_device *m68k, UINT32 An);

/* Operand fetching */
static inline UINT32 OPER_AY_AI_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_AI_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_AI_32(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_PI_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_PI_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_PI_32(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_PD_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_PD_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_PD_32(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_DI_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_DI_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_DI_32(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_IX_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_IX_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AY_IX_32(simpletoaplan_m68000_base_device *m68k);

static inline UINT32 OPER_AX_AI_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_AI_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_AI_32(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_PI_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_PI_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_PI_32(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_PD_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_PD_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_PD_32(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_DI_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_DI_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_DI_32(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_IX_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_IX_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AX_IX_32(simpletoaplan_m68000_base_device *m68k);

static inline UINT32 OPER_A7_PI_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_A7_PD_8(simpletoaplan_m68000_base_device *m68k);

static inline UINT32 OPER_AW_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AW_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AW_32(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AL_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AL_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_AL_32(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_PCDI_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_PCDI_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_PCDI_32(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_PCIX_8(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_PCIX_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 OPER_PCIX_32(simpletoaplan_m68000_base_device *m68k);

/* Stack operations */
static inline void m68ki_push_16(simpletoaplan_m68000_base_device *m68k, UINT32 value);
static inline void m68ki_push_32(simpletoaplan_m68000_base_device *m68k, UINT32 value);
static inline UINT32 m68ki_pull_16(simpletoaplan_m68000_base_device *m68k);
static inline UINT32 m68ki_pull_32(simpletoaplan_m68000_base_device *m68k);

/* Program flow operations */
static inline void m68ki_jump(simpletoaplan_m68000_base_device *m68k, UINT32 new_pc);
static inline void m68ki_jump_vector(simpletoaplan_m68000_base_device *m68k, UINT32 vector);
static inline void m68ki_branch_8(simpletoaplan_m68000_base_device *m68k, UINT32 offset);
static inline void m68ki_branch_16(simpletoaplan_m68000_base_device *m68k, UINT32 offset);
static inline void m68ki_branch_32(simpletoaplan_m68000_base_device *m68k, UINT32 offset);

/* Status register operations. */
static inline void m68ki_set_s_flag(simpletoaplan_m68000_base_device *m68k, UINT32 value);            /* Only bit 2 of value should be set (i.e. 4 or 0) */
static inline void m68ki_set_sm_flag(simpletoaplan_m68000_base_device *m68k, UINT32 value);           /* only bits 1 and 2 of value should be set */
static inline void m68ki_set_ccr(simpletoaplan_m68000_base_device *m68k, UINT32 value);               /* set the condition code register */
static inline void m68ki_set_sr(simpletoaplan_m68000_base_device *m68k, UINT32 value);                /* set the status register */
static inline void m68ki_set_sr_noint(simpletoaplan_m68000_base_device *m68k, UINT32 value);          /* set the status register */

/* Exception processing */
static inline UINT32 m68ki_init_exception(simpletoaplan_m68000_base_device *m68k);              /* Initial exception processing */

static inline void m68ki_stack_frame_3word(simpletoaplan_m68000_base_device *m68k, UINT32 pc, UINT32 sr); /* Stack various frame types */
static inline void m68ki_stack_frame_buserr(simpletoaplan_m68000_base_device *m68k, UINT32 sr);

static inline void m68ki_stack_frame_0000(simpletoaplan_m68000_base_device *m68k, UINT32 pc, UINT32 sr, UINT32 vector);
static inline void m68ki_stack_frame_0001(simpletoaplan_m68000_base_device *m68k, UINT32 pc, UINT32 sr, UINT32 vector);
static inline void m68ki_stack_frame_0010(simpletoaplan_m68000_base_device *m68k, UINT32 sr, UINT32 vector);
static inline void m68ki_stack_frame_1000(simpletoaplan_m68000_base_device *m68k, UINT32 pc, UINT32 sr, UINT32 vector);
static inline void m68ki_stack_frame_1010(simpletoaplan_m68000_base_device *m68k, UINT32 sr, UINT32 vector, UINT32 pc, UINT32 fault_address);
static inline void m68ki_stack_frame_1011(simpletoaplan_m68000_base_device *m68k, UINT32 sr, UINT32 vector, UINT32 pc, UINT32 fault_address);
static inline void m68ki_stack_frame_0111(simpletoaplan_m68000_base_device *m68k, UINT32 sr, UINT32 vector, UINT32 pc, UINT32 fault_address, bool in_mmu);

static inline void simpletoaplan_m68ki_exception_trap(simpletoaplan_m68000_base_device *m68k, UINT32 vector);
static inline void simpletoaplan_m68ki_exception_trapN(simpletoaplan_m68000_base_device *m68k, UINT32 vector);
static inline void simpletoaplan_m68ki_exception_trace(simpletoaplan_m68000_base_device *m68k);
static inline void simpletoaplan_m68ki_exception_privilege_violation(simpletoaplan_m68000_base_device *m68k);
static inline void simpletoaplan_m68ki_exception_1010(simpletoaplan_m68000_base_device *m68k);
static inline void simpletoaplan_m68ki_exception_1111(simpletoaplan_m68000_base_device *m68k);
static inline void simpletoaplan_m68ki_exception_illegal(simpletoaplan_m68000_base_device *m68k);
static inline void simpletoaplan_m68ki_exception_format_error(simpletoaplan_m68000_base_device *m68k);
static inline void simpletoaplan_m68ki_exception_address_error(simpletoaplan_m68000_base_device *m68k);

static inline void m68ki_check_interrupts(simpletoaplan_m68000_base_device *m68k);            /* ASG: check for interrupts */
...
static inline unsigned int m68k_read_pcrelative_8(simpletoaplan_m68000_base_device *m68k, unsigned int address)
{
	return ((m68k->readimm16(address&~1)>>(8*(1-(address & 1))))&0xff);
}

static inline unsigned int m68k_read_pcrelative_16(simpletoaplan_m68000_base_device *m68k, unsigned int address)
{
#if 0
	if (m_fastrom && address < 0x80000)
	{
		if (!WORD_ALIGNED(address))
		{
		//	return (m_fastrom[address-1] << 8);
			return 
		...
		{
			//printf("a\n");
			return m_fastrom[address] | (m_fastrom[address+1] << 8);
		}
	}
#endif
...
static inline unsigned int m68k_read_pcrelative_32(simpletoaplan_m68000_base_device *m68k, unsigned int address)
{
	if (!WORD_ALIGNED(address))
		return
 ...
 * low word to [address].
 */
static inline void m68kx_write_memory_32_pd(simpletoaplan_m68000_base_device *m68k, unsigned int address, unsigned int value)
{
...
static inline void m68ki_ic_clear(simpletoaplan_m68000_base_device *m68k)
{
	int i;
	for (i=0; i< SIMPLETOAPLAN_M68K_IC_SIZE; i++) {
		m68k->ic_address[i] = ~0;
	}
}
...
extern UINT16* m_fastrom;

static inline UINT32 m68ki_ic_readimm16(simpletoaplan_m68000_base_device *m68k, UINT32 address)
{
/*
	if (m68k->cacr & SIMPLETOAPLAN_M68K_CACR_EI)
	{
...
*/
	if (m_fastrom && (address < m_fastromsize))
		return m_fastrom[address >> 1];
...
static inline UINT32 m68ki_read_imm_16(simpletoaplan_m68000_base_device *m68k)
{
	...
	//simpletoaplan_m68ki_check_address_error(m68k, REG_PC(m68k), MODE_READ, m68k->s_flag | FUNCTION_CODE_USER_PROGRAM); /* auto-disable (see m68kcpu.h) */
...
static inline UINT32 m68ki_read_8_fc(simpletoaplan_m68000_base_device *m68k, UINT32 address, UINT32 fc)
{
	...
	if (m_fastrom && address < 0x80000)
	{
		//printf("m68ki_read_16_fc\n");
		return m_fastrom[address^1];
	}
#endif

//	printf("m68ki_read_8_fc %08x\n", address);
...
static inline UINT32 m68ki_read_16_fc(simpletoaplan_m68000_base_device *m68k, UINT32 address, UINT32 fc)
{
//	printf("m68ki_read_16_fc %08x\n", address);

//	if (CPU_TYPE_IS_010_LESS(m68k->cpu_type))
//	{
//		simpletoaplan_m68ki_check_address_error(m68k, address, MODE_READ, fc);
//	}
//	m68k->mmu_tmp_fc = fc;
//	m68k->mmu_tmp_rw = 1;
...
//	if (CPU_TYPE_IS_010_LESS(m68k->cpu_type))
//	{
//		simpletoaplan_m68ki_check_address_error(m68k, address, MODE_WRITE, fc);
//	}
//	m68k->mmu_tmp_fc = fc;
//	m68k->mmu_tmp_rw = 0;
...
static inline UINT32 m68ki_get_ea_ix(simpletoaplan_m68000_base_device *m68k, UINT32 An)
{
	...
	m68k->remaining_cycles -= simpletoaplan_m68ki_ea_idx_cycle_table[extension&0x3f];
...
/* Fetch operands */
static inline UINT32 OPER_AY_AI_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_AY_AI_8(m68k);  return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AY_AI_16(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AY_AI_16(m68k); return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AY_AI_32(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AY_AI_32(m68k); return m68ki_read_32(m68k, ea);}
static inline UINT32 OPER_AY_PI_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_AY_PI_8(m68k);  return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AY_PI_16(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AY_PI_16(m68k); return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AY_PI_32(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AY_PI_32(m68k); return m68ki_read_32(m68k, ea);}
static inline UINT32 OPER_AY_PD_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_AY_PD_8(m68k);  return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AY_PD_16(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AY_PD_16(m68k); return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AY_PD_32(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AY_PD_32(m68k); return m68ki_read_32(m68k, ea);}
static inline UINT32 OPER_AY_DI_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_AY_DI_8(m68k);  return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AY_DI_16(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AY_DI_16(m68k); return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AY_DI_32(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AY_DI_32(m68k); return m68ki_read_32(m68k, ea);}
static inline UINT32 OPER_AY_IX_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_AY_IX_8(m68k);  return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AY_IX_16(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AY_IX_16(m68k); return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AY_IX_32(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AY_IX_32(m68k); return m68ki_read_32(m68k, ea);}

static inline UINT32 OPER_AX_AI_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_AX_AI_8(m68k);  return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AX_AI_16(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AX_AI_16(m68k); return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AX_AI_32(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AX_AI_32(m68k); return m68ki_read_32(m68k, ea);}
static inline UINT32 OPER_AX_PI_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_AX_PI_8(m68k);  return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AX_PI_16(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AX_PI_16(m68k); return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AX_PI_32(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AX_PI_32(m68k); return m68ki_read_32(m68k, ea);}
static inline UINT32 OPER_AX_PD_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_AX_PD_8(m68k);  return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AX_PD_16(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AX_PD_16(m68k); return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AX_PD_32(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AX_PD_32(m68k); return m68ki_read_32(m68k, ea);}
static inline UINT32 OPER_AX_DI_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_AX_DI_8(m68k);  return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AX_DI_16(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AX_DI_16(m68k); return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AX_DI_32(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AX_DI_32(m68k); return m68ki_read_32(m68k, ea);}
static inline UINT32 OPER_AX_IX_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_AX_IX_8(m68k);  return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AX_IX_16(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AX_IX_16(m68k); return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AX_IX_32(simpletoaplan_m68000_base_device *m68k) {UINT32 ea = EA_AX_IX_32(m68k); return m68ki_read_32(m68k, ea);}

static inline UINT32 OPER_A7_PI_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_A7_PI_8(m68k);  return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_A7_PD_8(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_A7_PD_8(m68k);  return m68ki_read_8(m68k, ea); }

static inline UINT32 OPER_AW_8(simpletoaplan_m68000_base_device *m68k)     {UINT32 ea = EA_AW_8(m68k);     return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AW_16(simpletoaplan_m68000_base_device *m68k)    {UINT32 ea = EA_AW_16(m68k);    return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AW_32(simpletoaplan_m68000_base_device *m68k)    {UINT32 ea = EA_AW_32(m68k);    return m68ki_read_32(m68k, ea);}
static inline UINT32 OPER_AL_8(simpletoaplan_m68000_base_device *m68k)     {UINT32 ea = EA_AL_8(m68k);     return m68ki_read_8(m68k, ea); }
static inline UINT32 OPER_AL_16(simpletoaplan_m68000_base_device *m68k)    {UINT32 ea = EA_AL_16(m68k);    return m68ki_read_16(m68k, ea);}
static inline UINT32 OPER_AL_32(simpletoaplan_m68000_base_device *m68k)    {UINT32 ea = EA_AL_32(m68k);    return m68ki_read_32(m68k, ea);}
static inline UINT32 OPER_PCDI_8(simpletoaplan_m68000_base_device *m68k)   {UINT32 ea = EA_PCDI_8(m68k);   return m68ki_read_pcrel_8(m68k, ea); }
static inline UINT32 OPER_PCDI_16(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_PCDI_16(m68k);  return m68ki_read_pcrel_16(m68k, ea);}
static inline UINT32 OPER_PCDI_32(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_PCDI_32(m68k);  return m68ki_read_pcrel_32(m68k, ea);}
static inline UINT32 OPER_PCIX_8(simpletoaplan_m68000_base_device *m68k)   {UINT32 ea = EA_PCIX_8(m68k);   return m68ki_read_pcrel_8(m68k, ea); }
static inline UINT32 OPER_PCIX_16(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_PCIX_16(m68k);  return m68ki_read_pcrel_16(m68k, ea);}
static inline UINT32 OPER_PCIX_32(simpletoaplan_m68000_base_device *m68k)  {UINT32 ea = EA_PCIX_32(m68k);  return m68ki_read_pcrel_32(m68k, ea);}
 ...
 */
static inline void m68ki_fake_push_16(simpletoaplan_m68000_base_device *m68k)
{
	REG_SP(m68k) = MASK_OUT_ABOVE_32(REG_SP(m68k) - 2);
}

static inline void m68ki_fake_push_32(simpletoaplan_m68000_base_device *m68k)
{
	REG_SP(m68k) = MASK_OUT_ABOVE_32(REG_SP(m68k) - 4);
}

static inline void m68ki_fake_pull_16(simpletoaplan_m68000_base_device *m68k)
{
	REG_SP(m68k) = MASK_OUT_ABOVE_32(REG_SP(m68k) + 2);
}

static inline void m68ki_fake_pull_32(simpletoaplan_m68000_base_device *m68k)
{
	REG_SP(m68k) = MASK_OUT_ABOVE_32(REG_SP(m68k) + 4);
}
 ...
 */
static inline void m68ki_set_s_flag(simpletoaplan_m68000_base_device *m68k, UINT32 value)
{
 ...
 */
static inline void m68ki_set_sm_flag(simpletoaplan_m68000_base_device *m68k, UINT32 value)
{
	/* Backup the old stack pointer */
	REG_SP_BASE(m68k)[m68k->s_flag | ((m68k->s_flag>>1) & m68k->m_flag)] = REG_SP(m68k);
...
static inline void m68ki_set_sm_flag_nosp(simpletoaplan_m68000_base_device *m68k, UINT32 value)
{
	/* Set the S and M flags */
	m68k->s_flag = value & SFLAG_SET;
	m68k->m_flag = value & MFLAG_SET;
...
static inline void m68ki_set_ccr(simpletoaplan_m68000_base_device *m68k, UINT32 value)
{
...
static inline void m68ki_set_sr_noint(simpletoaplan_m68000_base_device *m68k, UINT32 value)
{
 ...
 */
static inline void m68ki_set_sr_noint_nosp(simpletoaplan_m68000_base_device *m68k, UINT32 value)
{
	/* Mask out the "unimplemented" bits */
	value &= m68k->sr_mask;
...
static inline void m68ki_set_sr(simpletoaplan_m68000_base_device *m68k, UINT32 value)
{
...
static inline UINT32 m68ki_init_exception(simpletoaplan_m68000_base_device *m68k)
{
...
static inline void m68ki_stack_frame_3word(simpletoaplan_m68000_base_device *m68k, UINT32 pc, UINT32 sr)
{
...
static inline void m68ki_check_interrupts(simpletoaplan_m68000_base_device *m68k)
{
	if(m68k->nmi_pending)
	{
		m68k->nmi_pending = FALSE;
		m68k->simpletoaplan_m68ki_exception_interrupt(m68k, 7);
	}
	else if(m68k->int_level > m68k->int_mask)
		m68k->simpletoaplan_m68ki_exception_interrupt(m68k, m68k->int_level>>8);
}
