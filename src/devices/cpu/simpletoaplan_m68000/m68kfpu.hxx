...
static inline floatx80 load_extended_float80(simpletoaplan_m68000_base_device *m68k, UINT32 ea)
{
	UINT32 d1,d2;
	UINT16 d3;
	floatx80 fp;
...
static inline void store_extended_float80(simpletoaplan_m68000_base_device *m68k, UINT32 ea, floatx80 fpr)
{
...
static inline floatx80 load_pack_float80(simpletoaplan_m68000_base_device *m68k, UINT32 ea)
{
	UINT32 dw1, dw2, dw3;
	floatx80 result;
	double tmp;
...
static inline void store_pack_float80(simpletoaplan_m68000_base_device *m68k, UINT32 ea, int k, floatx80 fpr)
{
	UINT32 dw1, dw2, dw3;
	char str[128], *ch;
	int i, j, exp;
...
static inline void SET_CONDITION_CODES(simpletoaplan_m68000_base_device *m68k, floatx80 reg)
{
//  UINT64 *regi;
...
static inline int TEST_CONDITION(simpletoaplan_m68000_base_device *m68k, int condition)
{
...
static UINT8 READ_EA_8(simpletoaplan_m68000_base_device *m68k, int ea)
{
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
static UINT16 READ_EA_16(simpletoaplan_m68000_base_device *m68k, int ea)
{
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
static UINT32 READ_EA_32(simpletoaplan_m68000_base_device *m68k, int ea)
{
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
static UINT64 READ_EA_64(simpletoaplan_m68000_base_device *m68k, int ea)
{
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
	UINT32 h1, h2;
...
static floatx80 READ_EA_FPE(simpletoaplan_m68000_base_device *m68k, int ea)
{
	floatx80 fpr;
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
static floatx80 READ_EA_PACK(simpletoaplan_m68000_base_device *m68k, int ea)
{
	floatx80 fpr;
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
static void WRITE_EA_8(simpletoaplan_m68000_base_device *m68k, int ea, UINT8 data)
{
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
static void WRITE_EA_16(simpletoaplan_m68000_base_device *m68k, int ea, UINT16 data)
{
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
static void WRITE_EA_32(simpletoaplan_m68000_base_device *m68k, int ea, UINT32 data)
{
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
static void WRITE_EA_64(simpletoaplan_m68000_base_device *m68k, int ea, UINT64 data)
{
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
static void WRITE_EA_FPE(simpletoaplan_m68000_base_device *m68k, int ea, floatx80 fpr)
{
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
static void WRITE_EA_PACK(simpletoaplan_m68000_base_device *m68k, int ea, int k, floatx80 fpr)
{
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
static void fpgen_rm_reg(simpletoaplan_m68000_base_device *m68k, UINT16 w2)
{
	int ea = m68k->ir & 0x3f;
	int rm = (w2 >> 14) & 0x1;
	int src = (w2 >> 10) & 0x7;
...
static void fmove_reg_mem(simpletoaplan_m68000_base_device *m68k, UINT16 w2)
{
	int ea = m68k->ir & 0x3f;
	int src = (w2 >>  7) & 0x7;
	int dst = (w2 >> 10) & 0x7;
...
static void fmove_fpcr(simpletoaplan_m68000_base_device *m68k, UINT16 w2)
{
	int ea = m68k->ir & 0x3f;
	int dir = (w2 >> 13) & 0x1;
...
static void fmovem(simpletoaplan_m68000_base_device *m68k, UINT16 w2)
{
	int i;
	int ea = m68k->ir & 0x3f;
	int dir = (w2 >> 13) & 0x1;
...
static void fscc(simpletoaplan_m68000_base_device *m68k)
{
	int ea = m68k->ir & 0x3f;
...
static void fbcc16(simpletoaplan_m68000_base_device *m68k)
{
	INT32 offset;
...
static void fbcc32(simpletoaplan_m68000_base_device *m68k)
{
	INT32 offset;
	int condition = m68k->ir & 0x3f;
...
void m68040_fpu_op0(simpletoaplan_m68000_base_device *m68k)
{
...
static int perform_fsave(simpletoaplan_m68000_base_device *m68k, UINT32 addr, int inc)
{
...
static void do_frestore_null(simpletoaplan_m68000_base_device *m68k)
{
	int i;
...
static void m68040_do_fsave(simpletoaplan_m68000_base_device *m68k, UINT32 addr, int reg, int inc)
{
...
static void m68040_do_frestore(simpletoaplan_m68000_base_device *m68k, UINT32 addr, int reg)
{
...
void m68040_fpu_op1(simpletoaplan_m68000_base_device *m68k)
{
	int ea = m68k->ir & 0x3f;
	int mode = (ea >> 3) & 0x7;
	int reg = (ea & 0x7);
...
void m68881_ftrap(simpletoaplan_m68000_base_device *m68k)
{
	UINT16 w2  = OPER_I_16(m68k);
	...
	{
		// trap here
		simpletoaplan_m68ki_exception_trap(m68k, EXCEPTION_TRAPV);
	}
