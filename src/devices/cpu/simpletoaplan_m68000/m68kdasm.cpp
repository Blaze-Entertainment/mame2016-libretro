...
#define SIMPLETOAPLAN_M68000_ONLY     (TYPE_68000 | TYPE_68008)

#define SIMPLETOAPLAN_M68010_ONLY     TYPE_68010
#define SIMPLETOAPLAN_M68010_LESS     (TYPE_68000 | TYPE_68008 | TYPE_68010)
#define SIMPLETOAPLAN_M68010_PLUS     (TYPE_68010 | TYPE_68020 | TYPE_68030 | TYPE_68040 | TYPE_68340 | TYPE_COLDFIRE)

#define SIMPLETOAPLAN_M68020_ONLY     (TYPE_68020 | TYPE_68340)
#define SIMPLETOAPLAN_M68020_LESS     (TYPE_68010 | TYPE_68020 | TYPE_68340)
#define SIMPLETOAPLAN_M68020_PLUS     (TYPE_68020 | TYPE_68030 | TYPE_68040 | TYPE_68340 | TYPE_COLDFIRE)

#define SIMPLETOAPLAN_M68030_ONLY     TYPE_68030
#define SIMPLETOAPLAN_M68030_LESS     (TYPE_68010 | TYPE_68020 | TYPE_68030 | TYPE_68340 )
#define SIMPLETOAPLAN_M68030_PLUS     (TYPE_68030 | TYPE_68040)

#define SIMPLETOAPLAN_M68040_PLUS     TYPE_68040
...
static char* get_ea_mode_str(UINT32 instruction, UINT32 size)
{
	...
	switch(instruction & 0x3f)
	{
		...
		/* address register indirect with index */
			...
			if((g_cpu_type & SIMPLETOAPLAN_M68010_LESS) && EXT_INDEX_SCALE(extension))
			{
				invalid_mode = 1;
				break;
			}
			...
			{
				if(g_cpu_type & SIMPLETOAPLAN_M68010_LESS)
				{
					invalid_mode = 1;
					break;
				}
...
{
	UINT32 temp_pc = g_cpu_pc;
	LIMIT_CPU_TYPES(SIMPLETOAPLAN_M68020_PLUS);
...
{
	LIMIT_CPU_TYPES(SIMPLETOAPLAN_M68010_PLUS);
...
{
	char* str;
	LIMIT_CPU_TYPES(SIMPLETOAPLAN_M68020_ONLY);
	str = get_imm_str_u8();
...
{
	LIMIT_CPU_TYPES(SIMPLETOAPLAN_M68040_PLUS);
...
{
	LIMIT_CPU_TYPES(SIMPLETOAPLAN_M68030_PLUS);
	UINT32 temp_pc = g_cpu_pc;
...
static unsigned int m68k_disassemble(char* str_buff, unsigned int pc, unsigned int cpu_type)
{
	...
	switch(cpu_type)
	{
		case SIMPLETOAPLAN_M68K_CPU_TYPE_68000:
			g_cpu_type = TYPE_68000;
			break;
		case SIMPLETOAPLAN_M68K_CPU_TYPE_68008:
			g_cpu_type = TYPE_68008;
			break;
		case SIMPLETOAPLAN_M68K_CPU_TYPE_68010:
			g_cpu_type = TYPE_68010;
			break;
		case SIMPLETOAPLAN_M68K_CPU_TYPE_68EC020:
		case SIMPLETOAPLAN_M68K_CPU_TYPE_68020:
			g_cpu_type = TYPE_68020;
			break;
		case SIMPLETOAPLAN_M68K_CPU_TYPE_68EC030:
		case SIMPLETOAPLAN_M68K_CPU_TYPE_68030:
			g_cpu_type = TYPE_68030;
			break;
		case SIMPLETOAPLAN_M68K_CPU_TYPE_68040:
		case SIMPLETOAPLAN_M68K_CPU_TYPE_68EC040:
		case SIMPLETOAPLAN_M68K_CPU_TYPE_68LC040:
			g_cpu_type = TYPE_68040;
			break;
		case SIMPLETOAPLAN_M68K_CPU_TYPE_SIMPLETOAPLAN_FSCPU32:
			g_cpu_type = TYPE_68340;
			break;
		case SIMPLETOAPLAN_M68K_CPU_TYPE_COLDFIRE:
...
unsigned int m68k_is_valid_instruction(unsigned int instruction, unsigned int cpu_type)
{
	...
	if(cpu_type != SIMPLETOAPLAN_M68K_CPU_TYPE_68020 && cpu_type != SIMPLETOAPLAN_M68K_CPU_TYPE_68EC020 &&
