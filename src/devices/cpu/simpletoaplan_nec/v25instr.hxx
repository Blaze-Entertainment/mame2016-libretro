...
OP( 0x0f, i_pre_v25  ) { UINT32 ModRM, tmp, tmp2;
	switch (FETCH()) {
		...
		case 0x2d : GetRB; simpletoaplan_nec_bankswitch(tmp); CLK(15); break;
		...
		default:    logerror("%06x: Unknown SIMPLETOAPLAN_V25 instruction\n",PC()); break;
	}
}

OP( 0x63, i_brkn   ) { simpletoaplan_nec_interrupt(FETCH(), BRKN); CLKS(50,50,24); }
OP( 0xF1, i_brks   ) { simpletoaplan_nec_interrupt(FETCH(), BRKS); CLKS(50,50,24); }
