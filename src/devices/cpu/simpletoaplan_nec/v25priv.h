...
#define SIMPLETOAPLAN_V33_TYPE 0
#define SIMPLETOAPLAN_V30_TYPE 8
#define SIMPLETOAPLAN_V20_TYPE 16
...
enum
{
	SIMPLETOAPLAN_NEC_DIVIDE_VECTOR   = 0,
	SIMPLETOAPLAN_NEC_TRAP_VECTOR     = 1,
	SIMPLETOAPLAN_NEC_NMI_VECTOR      = 2,
	SIMPLETOAPLAN_NEC_BRKV_VECTOR     = 4,
	SIMPLETOAPLAN_NEC_CHKIND_VECTOR   = 5,
	SIMPLETOAPLAN_NEC_IBRK_VECTOR     = 19,
	SIMPLETOAPLAN_NEC_INTTU0_VECTOR   = 28,
	SIMPLETOAPLAN_NEC_INTTU1_VECTOR   = 29,
	SIMPLETOAPLAN_NEC_INTTU2_VECTOR   = 30,
	SIMPLETOAPLAN_NEC_INTD0_VECTOR    = 20,
	SIMPLETOAPLAN_NEC_INTD1_VECTOR    = 21,
	SIMPLETOAPLAN_NEC_INTP0_VECTOR    = 24,
	SIMPLETOAPLAN_NEC_INTP1_VECTOR    = 25,
	SIMPLETOAPLAN_NEC_INTP2_VECTOR    = 26,
	SIMPLETOAPLAN_NEC_INTSER0_VECTOR  = 12,
	SIMPLETOAPLAN_NEC_INTSR0_VECTOR   = 13,
	SIMPLETOAPLAN_NEC_INTST0_VECTOR   = 14,
	SIMPLETOAPLAN_NEC_INTSER1_VECTOR  = 16,
	SIMPLETOAPLAN_NEC_INTSR1_VECTOR   = 17,
	SIMPLETOAPLAN_NEC_INTST1_VECTOR   = 18,
	SIMPLETOAPLAN_NEC_INTTB_VECTOR    = 31
};
...
#define read_mem_byte(a)            simpletoaplan_v25_read_byte((a))
#define read_mem_word(a)            simpletoaplan_v25_read_word((a))
#define write_mem_byte(a,d)         simpletoaplan_v25_write_byte((a),(d))
#define write_mem_word(a,d)         simpletoaplan_v25_write_word((a),(d))
