...
/* V53IREMKENGOIREMKENGO */

// V33IREMKENGO / V33AIREMKENGO cores with onboard peripherals
...
const device_type V53IREMKENGOIREMKENGO = &device_creator<v53_iremkengo_device>;
const device_type V53IREMKENGOIREMKENGOA =&device_creator<v53a_iremkengo_device>;

WRITE8_MEMBER(v53_base_iremkengo_device::BSEL_w)
{
	//printf("v53: BSEL_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::BADR_w)
{
	//printf("v53: BADR_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::BRC_w)
{
	//printf("v53: BRC_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::WMB0_w)
{
	//printf("v53: WMB0_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::WCY1_w)
{
	//printf("v53: WCY1_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::WCY0_w)
{
	//printf("v53: WCY0_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::WAC_w)
{
	//printf("v53: WAC_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::TCKS_w)
{
	//printf("v53: TCKS_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::SBCR_w)
{
	//printf("v53: SBCR_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::REFC_w)
{
	//printf("v53: REFC_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::WMB1_w)
{
	//printf("v53: WMB1_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::WCY2_w)
{
	//printf("v53: WCY2_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::WCY3_w)
{
	//printf("v53: WCY3_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::WCY4_w)
{
	//printf("v53: WCY4_w %02x\n", data);
}

WRITE8_MEMBER(v53_base_iremkengo_device::SULA_w)
{
...
WRITE8_MEMBER(v53_base_iremkengo_device::TULA_w)
{
...
WRITE8_MEMBER(v53_base_iremkengo_device::IULA_w)
{
...
WRITE8_MEMBER(v53_base_iremkengo_device::DULA_w)
{
...
WRITE8_MEMBER(v53_base_iremkengo_device::OPHA_w)
{
...
WRITE8_MEMBER(v53_base_iremkengo_device::OPSEL_w)
{
...
WRITE8_MEMBER(v53_base_iremkengo_device::SCTL_w)
{
	// bit 7: unused
	// bit 6: unused
	// bit 5: unused
...
void v53_base_iremkengo_device::device_reset()
{
	nec_common_iremkengo_device::device_reset();
...
void v53_base_iremkengo_device::device_start()
{
	nec_common_iremkengo_device::device_start();
...
void v53_base_iremkengo_device::install_peripheral_io()
{
	...
	if (m_OPSEL & 0x04) // Timer Control Unit available
	{
		...
		{
			space(AS_IO).install_readwrite_handler(base+0x00, base+0x01, read8_delegate(FUNC(v53_base_iremkengo_device::tmu_tst0_r), this), write8_delegate(FUNC(v53_base_iremkengo_device::tmu_tct0_w), this), 0x00ff);
			space(AS_IO).install_readwrite_handler(base+0x02, base+0x03, read8_delegate(FUNC(v53_base_iremkengo_device::tmu_tst1_r), this), write8_delegate(FUNC(v53_base_iremkengo_device::tmu_tct1_w), this), 0x00ff);
			space(AS_IO).install_readwrite_handler(base+0x04, base+0x05, read8_delegate(FUNC(v53_base_iremkengo_device::tmu_tst2_r), this), write8_delegate(FUNC(v53_base_iremkengo_device::tmu_tct2_w), this), 0x00ff);
			space(AS_IO).install_write_handler(base+0x06, base+0x07, write8_delegate(FUNC(v53_base_iremkengo_device::tmu_tmd_w), this), 0x00ff);
		}
	}
	...
	if (m_OPSEL & 0x08) // Serial Control Unit available
	{
		...
		else
		{
			...
			space(AS_IO).install_readwrite_handler(base+0x06, base+0x07, read8_delegate(FUNC(v53_base_iremkengo_device::scu_simk_r), this), write8_delegate(FUNC(v53_base_iremkengo_device::scu_simk_w), this), 0x00ff);
...
READ8_MEMBER(v53_base_iremkengo_device::scu_simk_r)
{
	//printf("v53: scu_simk_r\n");
	return m_simk;
}

WRITE8_MEMBER(v53_base_iremkengo_device::scu_simk_w)
{
	m_simk = data;
...
WRITE8_MEMBER(v53_base_iremkengo_device::tmu_tct0_w) { m_v53tcu->write(space, 0, data); }
WRITE8_MEMBER(v53_base_iremkengo_device::tmu_tct1_w) { m_v53tcu->write(space, 1, data); }
WRITE8_MEMBER(v53_base_iremkengo_device::tmu_tct2_w) { m_v53tcu->write(space, 2, data); }
WRITE8_MEMBER(v53_base_iremkengo_device::tmu_tmd_w)  { m_v53tcu->write(space, 3, data); }


READ8_MEMBER(v53_base_iremkengo_device::tmu_tst0_r) { return m_v53tcu->read(space, 0); }
READ8_MEMBER(v53_base_iremkengo_device::tmu_tst1_r) { return m_v53tcu->read(space, 1); }
READ8_MEMBER(v53_base_iremkengo_device::tmu_tst2_r) { return m_v53tcu->read(space, 2); }
...
WRITE_LINE_MEMBER(v53_base_iremkengo_device::dreq0_w)
{
	if (!(m_SCTL & 0x02))
	{
...
WRITE_LINE_MEMBER(v53_base_iremkengo_device::dreq1_w)
{
	if (!(m_SCTL & 0x02))
	{
...
WRITE_LINE_MEMBER(v53_base_iremkengo_device::dreq2_w)
{
	if (!(m_SCTL & 0x02))
	{
...
WRITE_LINE_MEMBER(v53_base_iremkengo_device::dreq3_w)
{
	if (!(m_SCTL & 0x02))
	{
...
WRITE_LINE_MEMBER(v53_base_iremkengo_device::hack_w)
{
	if (!(m_SCTL & 0x02))
	{
...
static ADDRESS_MAP_START( v53_internal_port_map, AS_IO, 16, v53_base_iremkengo_device )
...
READ8_MEMBER(v53_base_iremkengo_device::get_pic_ack)
{
	return 0;
}
...
// the external interface provides no external access to the usual IRQ line of the V33IREMKENGO, everything goes through the interrupt controller
void v53_base_iremkengo_device::execute_set_input(int irqline, int state)
{
	switch (irqline)
	{
		...
		case INPUT_LINE_NMI: nec_common_iremkengo_device::execute_set_input(irqline, state); break;
		case NEC_IREMKENGO_INPUT_LINE_POLL: nec_common_iremkengo_device::execute_set_input(irqline, state); break;
	}
}

// for hooking the interrupt controller output up to the core
WRITE_LINE_MEMBER(v53_base_iremkengo_device::internal_irq_w)
{
	nec_common_iremkengo_device::execute_set_input(0, state);
}
...
static MACHINE_CONFIG_FRAGMENT( v53 )
	...
	MCFG_PIT8253_OUT0_HANDLER(WRITELINE( v53_base_iremkengo_device, tcu_out0_trampoline_cb ))
	MCFG_PIT8253_OUT1_HANDLER(WRITELINE( v53_base_iremkengo_device, tcu_out1_trampoline_cb ))
	MCFG_PIT8253_OUT2_HANDLER(WRITELINE( v53_base_iremkengo_device, tcu_out2_trampoline_cb ))


	MCFG_DEVICE_ADD("upd71071dma", V53_DMAU, 4000000)
	MCFG_AM9517A_OUT_HREQ_CB(WRITELINE(v53_base_iremkengo_device, hreq_trampoline_cb))
	MCFG_AM9517A_OUT_EOP_CB(WRITELINE(v53_base_iremkengo_device, eop_trampoline_cb))
	MCFG_AM9517A_IN_MEMR_CB(READ8(v53_base_iremkengo_device, dma_memr_trampoline_r))
	MCFG_AM9517A_OUT_MEMW_CB(WRITE8(v53_base_iremkengo_device, dma_memw_trampoline_w))
	MCFG_AM9517A_IN_IOR_0_CB(READ8(v53_base_iremkengo_device, dma_io_0_trampoline_r))
	MCFG_AM9517A_IN_IOR_1_CB(READ8(v53_base_iremkengo_device, dma_io_1_trampoline_r))
	MCFG_AM9517A_IN_IOR_2_CB(READ8(v53_base_iremkengo_device, dma_io_2_trampoline_r))
	MCFG_AM9517A_IN_IOR_3_CB(READ8(v53_base_iremkengo_device, dma_io_3_trampoline_r))
	MCFG_AM9517A_OUT_IOW_0_CB(WRITE8(v53_base_iremkengo_device, dma_io_0_trampoline_w))
	MCFG_AM9517A_OUT_IOW_1_CB(WRITE8(v53_base_iremkengo_device, dma_io_1_trampoline_w))
	MCFG_AM9517A_OUT_IOW_2_CB(WRITE8(v53_base_iremkengo_device, dma_io_2_trampoline_w))
	MCFG_AM9517A_OUT_IOW_3_CB(WRITE8(v53_base_iremkengo_device, dma_io_3_trampoline_w))
	MCFG_AM9517A_OUT_DACK_0_CB(WRITELINE(v53_base_iremkengo_device, dma_dack0_trampoline_w))
	MCFG_AM9517A_OUT_DACK_1_CB(WRITELINE(v53_base_iremkengo_device, dma_dack1_trampoline_w))
	MCFG_AM9517A_OUT_DACK_2_CB(WRITELINE(v53_base_iremkengo_device, dma_dack2_trampoline_w))
	MCFG_AM9517A_OUT_DACK_3_CB(WRITELINE(v53_base_iremkengo_device, dma_dack3_trampoline_w))


	MCFG_PIC8259_ADD( "upd71059pic", WRITELINE(v53_base_iremkengo_device, internal_irq_w), VCC, READ8(v53_base_iremkengo_device,get_pic_ack))



	MCFG_DEVICE_ADD("v53scu", V53_SCU, 0)
	MCFG_I8251_TXD_HANDLER(WRITELINE(v53_base_iremkengo_device, scu_txd_trampoline_cb))
	MCFG_I8251_DTR_HANDLER(WRITELINE(v53_base_iremkengo_device, scu_dtr_trampoline_cb))
	MCFG_I8251_RTS_HANDLER(WRITELINE(v53_base_iremkengo_device, scu_rts_trampoline_cb))
	MCFG_I8251_RXRDY_HANDLER(WRITELINE(v53_base_iremkengo_device,scu_rxrdy_trampoline_cb))
	MCFG_I8251_TXRDY_HANDLER(WRITELINE(v53_base_iremkengo_device,scu_txrdy_trampoline_cb))
	MCFG_I8251_TXEMPTY_HANDLER(WRITELINE(v53_base_iremkengo_device, scu_txempty_trampoline_cb))
	MCFG_I8251_SYNDET_HANDLER(WRITELINE(v53_base_iremkengo_device, scu_syndet_trampoline_cb))

MACHINE_CONFIG_END

machine_config_constructor v53_base_iremkengo_device::device_mconfig_additions() const
{
	return MACHINE_CONFIG_NAME( v53 );
}


v53_base_iremkengo_device::v53_base_iremkengo_device(const machine_config &mconfig, device_type type, const char *name, const char *tag, device_t *owner, UINT32 clock, const char *shortname, offs_t fetch_xor, UINT8 prefetch_size, UINT8 prefetch_cycles, UINT32 chip_type)
	: nec_common_iremkengo_device(mconfig, type, name, tag, owner, clock, shortname, __FILE__, true, fetch_xor, prefetch_size, prefetch_cycles, chip_type),
...
v53_iremkengo_device::v53_iremkengo_device(const machine_config &mconfig, const char *tag, device_t *owner, UINT32 clock)
	: v53_base_iremkengo_device(mconfig, V53IREMKENGOIREMKENGO, "V53IREMKENGOIREMKENGO", tag, owner, clock, "v53", BYTE_XOR_LE(0), 6, 1, V33IREMKENGO_TYPE)
{
}


v53a_iremkengo_device::v53a_iremkengo_device(const machine_config &mconfig, const char *tag, device_t *owner, UINT32 clock)
	: v53_base_iremkengo_device(mconfig, V53IREMKENGOIREMKENGOA, "V53IREMKENGOIREMKENGOA", tag, owner, clock, "v53a", BYTE_XOR_LE(0), 6, 1, V33IREMKENGO_TYPE)
{
}
