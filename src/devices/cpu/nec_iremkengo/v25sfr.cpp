...
/****************************************************************************
    ...
    NEC V25IREMKENGO/V35IREMKENGO special function registers and internal ram access
...
UINT8 v25_common_iremkengo_device::read_irqcontrol(int /*INTSOURCES*/ source, UINT8 priority)
{
...
UINT8 v25_common_iremkengo_device::read_sfr(unsigned o)
{
	UINT8 ret;
	...
	{
		case 0x00: /* P0 */
			ret = m_io->read_byte(V25IREMKENGO_PORT_P0);
			break;
		case 0x08: /* P1 */
			/* P1 is combined with the interrupt lines */
			ret = ((m_io->read_byte(V25IREMKENGO_PORT_P1) & 0xF0)
			...
			break;
		case 0x10: /* P2 */
			ret = m_io->read_byte(V25IREMKENGO_PORT_P2);
			break;
		case 0x38: /* PT */
			ret = m_io->read_byte(V25IREMKENGO_PORT_PT);
			break;
		case 0x4C: /* EXIC0 */
...
UINT16 v25_common_iremkengo_device::read_sfr_word(unsigned o)
{
	UINT16 ret;
...
void v25_common_iremkengo_device::write_irqcontrol(int /*INTSOURCES*/ source, UINT8 d)
{
	if(d & 0x80)
...
void v25_common_iremkengo_device::write_sfr(unsigned o, UINT8 d)
{
	int tmp;
	attotime time;
	...
	{
		case 0x00: /* P0 */
			m_io->write_byte(V25IREMKENGO_PORT_P0, d);
			break;
		case 0x08: /* P1 */
			/* only the upper four bits of P1 can be used as output */
			m_io->write_byte(V25IREMKENGO_PORT_P1, d & 0xF0);
			break;
		case 0x10: /* P2 */
			m_io->write_byte(V25IREMKENGO_PORT_P2, d);
			break;
		case 0x4C: /* EXIC0 */
...
void v25_common_iremkengo_device::write_sfr_word(unsigned o, UINT16 d)
{
	switch(o)
	{
		case 0x80:  /* TM0 */
...
UINT8 v25_common_iremkengo_device::v25_read_byte(unsigned a)
{
...
UINT16 v25_common_iremkengo_device::v25_read_word(unsigned a)
{
	if( a & 1 )
...
void v25_common_iremkengo_device::v25_write_byte(unsigned a, UINT8 d)
{
	if((a & 0xFFE00) == m_IDB || a == 0xFFFFF)
	{
		unsigned o = a & 0x1FF;
...
void v25_common_iremkengo_device::v25_write_word(unsigned a, UINT16 d)
{
	if( a & 1 )
	{
		v25_write_byte(a, d);
