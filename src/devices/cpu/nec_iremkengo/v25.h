...
#ifndef __NEC_IREMKENGO_V25IREMKENGO_H_
#define __NEC_IREMKENGO_V25IREMKENGO_H_


#define NEC_IREMKENGO_INPUT_LINE_INTP0 10
#define NEC_IREMKENGO_INPUT_LINE_INTP1 11
#define NEC_IREMKENGO_INPUT_LINE_INTP2 12
#define NEC_IREMKENGO_INPUT_LINE_POLL 20

#define V25IREMKENGO_PORT_P0 0x10000
#define V25IREMKENGO_PORT_P1 0x10002
#define V25IREMKENGO_PORT_P2 0x10004
#define V25IREMKENGO_PORT_PT 0x10006

enum
{
	V25IREMKENGO_PC=0,
	V25IREMKENGO_IP, V25IREMKENGO_AW, V25IREMKENGO_CW, V25IREMKENGO_DW, V25IREMKENGO_BW, V25IREMKENGO_SP, V25IREMKENGO_BP, V25IREMKENGO_IX, V25IREMKENGO_IY,
	V25IREMKENGO_FLAGS, V25IREMKENGO_ES, V25IREMKENGO_CS, V25IREMKENGO_SS, V25IREMKENGO_DS,
	V25IREMKENGO_PENDING
};


#define MCFG_V25IREMKENGO_CONFIG(_table) \
	v25_common_iremkengo_device::set_decryption_table(*device, _table);


class v25_common_iremkengo_device : public cpu_device
{
public:
	// construction/destruction
	v25_common_iremkengo_device(const machine_config &mconfig, device_type type, const char *name, const char *tag, device_t *owner, UINT32 clock, const char *shortname, bool is_16bit, offs_t fetch_xor, UINT8 prefetch_size, UINT8 prefetch_cycles, UINT32 chip_type);

	// static configuration helpers
	static void set_decryption_table(device_t &device, const UINT8 *decryption_table) { downcast<v25_common_iremkengo_device &>(device).m_v25v35_decryptiontable = decryption_table; }
...
union internalram
{
	...
	typedef void (v25_common_iremkengo_device::*nec_ophandler)();
	typedef UINT32 (v25_common_iremkengo_device::*nec_eahandler)();
...
class v25_iremkengo_device : public v25_common_iremkengo_device
{
public:
	v25_iremkengo_device(const machine_config &mconfig, const char *tag, device_t *owner, UINT32 clock);
};


class v35_iremkengo_device : public v25_common_iremkengo_device
{
public:
	v35_iremkengo_device(const machine_config &mconfig, const char *tag, device_t *owner, UINT32 clock);
};


extern const device_type V25IREMKENGO;
extern const device_type V35IREMKENGO;
