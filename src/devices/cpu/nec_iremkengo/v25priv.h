...
#define V33IREMKENGO_TYPE 0
#define V30IREMKENGO_TYPE 8
#define V20IREMKENGO_TYPE 16
...
enum
{
	NEC_IREMKENGO_DIVIDE_VECTOR   = 0,
	NEC_IREMKENGO_TRAP_VECTOR     = 1,
	NEC_IREMKENGO_NMI_VECTOR      = 2,
	NEC_IREMKENGO_BRKV_VECTOR     = 4,
	NEC_IREMKENGO_CHKIND_VECTOR   = 5,
	NEC_IREMKENGO_IBRK_VECTOR     = 19,
	NEC_IREMKENGO_INTTU0_VECTOR   = 28,
	NEC_IREMKENGO_INTTU1_VECTOR   = 29,
	NEC_IREMKENGO_INTTU2_VECTOR   = 30,
	NEC_IREMKENGO_INTD0_VECTOR    = 20,
	NEC_IREMKENGO_INTD1_VECTOR    = 21,
	NEC_IREMKENGO_INTP0_VECTOR    = 24,
	NEC_IREMKENGO_INTP1_VECTOR    = 25,
	NEC_IREMKENGO_INTP2_VECTOR    = 26,
	NEC_IREMKENGO_INTSER0_VECTOR  = 12,
	NEC_IREMKENGO_INTSR0_VECTOR   = 13,
	NEC_IREMKENGO_INTST0_VECTOR   = 14,
	NEC_IREMKENGO_INTSER1_VECTOR  = 16,
	NEC_IREMKENGO_INTSR1_VECTOR   = 17,
	NEC_IREMKENGO_INTST1_VECTOR   = 18,
	NEC_IREMKENGO_INTTB_VECTOR    = 31
};
