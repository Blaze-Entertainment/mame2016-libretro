...
#ifndef __NEC_IREMSOUND_V25IREMSOUND_H_
#define __NEC_IREMSOUND_V25IREMSOUND_H_


#define NEC_IREMSOUND_INPUT_LINE_INTP0 10
#define NEC_IREMSOUND_INPUT_LINE_INTP1 11
#define NEC_IREMSOUND_INPUT_LINE_INTP2 12
#define NEC_IREMSOUND_INPUT_LINE_POLL 20

#define V25IREMSOUND_PORT_P0 0x10000
#define V25IREMSOUND_PORT_P1 0x10002
#define V25IREMSOUND_PORT_P2 0x10004
#define V25IREMSOUND_PORT_PT 0x10006

enum
{
	V25IREMSOUND_PC=0,
	V25IREMSOUND_IP, V25IREMSOUND_AW, V25IREMSOUND_CW, V25IREMSOUND_DW, V25IREMSOUND_BW, V25IREMSOUND_SP, V25IREMSOUND_BP, V25IREMSOUND_IX, V25IREMSOUND_IY,
	V25IREMSOUND_FLAGS, V25IREMSOUND_ES, V25IREMSOUND_CS, V25IREMSOUND_SS, V25IREMSOUND_DS,
	V25IREMSOUND_PENDING
};


#define MCFG_V25IREMSOUND_CONFIG(_table) \
	v25_common_iremsound_device::set_decryption_table(*device, _table);


class v25_common_iremsound_device : public cpu_device
{
public:
	// construction/destruction
	v25_common_iremsound_device(const machine_config &mconfig, device_type type, const char *name, const char *tag, device_t *owner, UINT32 clock, const char *shortname, bool is_16bit, offs_t fetch_xor, UINT8 prefetch_size, UINT8 prefetch_cycles, UINT32 chip_type);

	// static configuration helpers
	static void set_decryption_table(device_t &device, const UINT8 *decryption_table) { downcast<v25_common_iremsound_device &>(device).m_v25v35_decryptiontable = decryption_table; }
...
union internalram
{
	...
	typedef void (v25_common_iremsound_device::*nec_ophandler)();
	typedef UINT32 (v25_common_iremsound_device::*nec_eahandler)();
...
class v25_iremsound_device : public v25_common_iremsound_device
{
public:
	v25_iremsound_device(const machine_config &mconfig, const char *tag, device_t *owner, UINT32 clock);
};


class v35_iremsound_device : public v25_common_iremsound_device
{
public:
	v35_iremsound_device(const machine_config &mconfig, const char *tag, device_t *owner, UINT32 clock);
};


extern const device_type V25IREMSOUND;
extern const device_type V35IREMSOUND;
