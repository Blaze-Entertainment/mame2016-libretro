...
#define V33IREMSOUND_TYPE 0
#define V30IREMSOUND_TYPE 8
#define V20IREMSOUND_TYPE 16
...
enum
{
	NEC_IREMSOUND_DIVIDE_VECTOR   = 0,
	NEC_IREMSOUND_TRAP_VECTOR     = 1,
	NEC_IREMSOUND_NMI_VECTOR      = 2,
	NEC_IREMSOUND_BRKV_VECTOR     = 4,
	NEC_IREMSOUND_CHKIND_VECTOR   = 5,
	NEC_IREMSOUND_IBRK_VECTOR     = 19,
	NEC_IREMSOUND_INTTU0_VECTOR   = 28,
	NEC_IREMSOUND_INTTU1_VECTOR   = 29,
	NEC_IREMSOUND_INTTU2_VECTOR   = 30,
	NEC_IREMSOUND_INTD0_VECTOR    = 20,
	NEC_IREMSOUND_INTD1_VECTOR    = 21,
	NEC_IREMSOUND_INTP0_VECTOR    = 24,
	NEC_IREMSOUND_INTP1_VECTOR    = 25,
	NEC_IREMSOUND_INTP2_VECTOR    = 26,
	NEC_IREMSOUND_INTSER0_VECTOR  = 12,
	NEC_IREMSOUND_INTSR0_VECTOR   = 13,
	NEC_IREMSOUND_INTST0_VECTOR   = 14,
	NEC_IREMSOUND_INTSER1_VECTOR  = 16,
	NEC_IREMSOUND_INTSR1_VECTOR   = 17,
	NEC_IREMSOUND_INTST1_VECTOR   = 18,
	NEC_IREMSOUND_INTTB_VECTOR    = 31
};
