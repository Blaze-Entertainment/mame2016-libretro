...
void cps_state::show_tile_data(int tile)
{
	int height = 16;
	int width = 16;
	...
	for (int y = 0; y < height; y++)
	{
		...
		{
			int lineaddr = tilebase + y * (width / 2);
			lineaddr += x * 4;

			uint8 pix[8];

			pix[0] = ((rom[lineaddr+0] & 0x80) >> 7) | ((rom[lineaddr+1] & 0x80) >> 6) | ((rom[lineaddr+2] & 0x80) >> 5) | ((rom[lineaddr+3] & 0x80) >> 4);
			pix[1] = ((rom[lineaddr+0] & 0x40) >> 6) | ((rom[lineaddr+1] & 0x40) >> 5) | ((rom[lineaddr+2] & 0x40) >> 4) | ((rom[lineaddr+3] & 0x40) >> 3);
			pix[2] = ((rom[lineaddr+0] & 0x20) >> 5) | ((rom[lineaddr+1] & 0x20) >> 4) | ((rom[lineaddr+2] & 0x20) >> 3) | ((rom[lineaddr+3] & 0x20) >> 2);
			pix[3] = ((rom[lineaddr+0] & 0x10) >> 4) | ((rom[lineaddr+1] & 0x10) >> 3) | ((rom[lineaddr+2] & 0x10) >> 2) | ((rom[lineaddr+3] & 0x10) >> 1);
			pix[4] = ((rom[lineaddr+0] & 0x08) >> 3) | ((rom[lineaddr+1] & 0x08) >> 2) | ((rom[lineaddr+2] & 0x08) >> 1) | ((rom[lineaddr+3] & 0x08) >> 0);
			pix[5] = ((rom[lineaddr+0] & 0x04) >> 2) | ((rom[lineaddr+1] & 0x04) >> 1) | ((rom[lineaddr+2] & 0x04) >> 0) | ((rom[lineaddr+3] & 0x04) << 1);
			pix[6] = ((rom[lineaddr+0] & 0x02) >> 1) | ((rom[lineaddr+1] & 0x02) >> 0) | ((rom[lineaddr+2] & 0x02) << 1) | ((rom[lineaddr+3] & 0x02) << 2);
			pix[7] = ((rom[lineaddr+0] & 0x01) >> 0) | ((rom[lineaddr+1] & 0x01) << 1) | ((rom[lineaddr+2] & 0x01) << 2) | ((rom[lineaddr+3] & 0x01) << 3);
...
void cps_state::put_tile_data(int tile, uint8_t* data)
{
	int height = 16;
	int width = 16;
	int tilesize = (4 * width * height) / 8;
	...
	for (int y = 0; y < height; y++)
	{
		for (int x = 0; x < width / 8; x++)
		{
			...
			uint8* pix = (data + y * width) + x * 8;

			rom[lineaddr + 0] = ((pix[0] & 0x01) << 7) | ((pix[1] & 0x01) << 6) | ((pix[2] & 0x01) << 5) | ((pix[3] & 0x01) << 4) | ((pix[4] & 0x01) << 3) | ((pix[5] & 0x01) << 2) | ((pix[6] & 0x01) << 1) | ((pix[7] & 0x01) << 0);
			rom[lineaddr + 1] = ((pix[0] & 0x02) << 6) | ((pix[1] & 0x02) << 5) | ((pix[2] & 0x02) << 4) | ((pix[3] & 0x02) << 3) | ((pix[4] & 0x02) << 2) | ((pix[5] & 0x02) << 1) | ((pix[6] & 0x02) << 0) | ((pix[7] & 0x02) >> 1);
			rom[lineaddr + 2] = ((pix[0] & 0x04) << 5) | ((pix[1] & 0x04) << 4) | ((pix[2] & 0x04) << 3) | ((pix[3] & 0x04) << 2) | ((pix[4] & 0x04) << 1) | ((pix[5] & 0x04) << 0) | ((pix[6] & 0x04) >> 1) | ((pix[7] & 0x04) >> 2);
			rom[lineaddr + 3] = ((pix[0] & 0x08) << 4) | ((pix[1] & 0x08) << 3) | ((pix[2] & 0x08) << 2) | ((pix[3] & 0x08) << 1) | ((pix[4] & 0x08) << 0) | ((pix[5] & 0x08) >> 1) | ((pix[6] & 0x08) >> 2) | ((pix[7] & 0x08) >> 3);
		}
	}
}


uint8_t show_tile_data_1dc8[16 * 16] = {
0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf,
0xf, 0xf, 0xf, 0xf, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0xf, 0xf,
0xf, 0xf, 0xf, 0x9, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0x9, 0xf,
0xf, 0xf, 0x9, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0x9,
0xf, 0x9, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf,
0xf, 0x9, 0xf, 0xf, 0xf, 0xf, 0x1, 0x1, 0x1, 0x1, 0x1, 0x1, 0xf, 0xf, 0xf, 0xf,
0xf, 0x9, 0xf, 0xf, 0xf, 0xf, 0x1, 0xf, 0xf, 0xf, 0xf, 0x1, 0xf, 0xf, 0xf, 0xf,
0xf, 0x3, 0x4, 0x4, 0x4, 0x4, 0x4, 0x4, 0x4, 0x4, 0x4, 0x4, 0x4, 0x4, 0x4, 0x4,
0x3, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa,
0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa,
0x2, 0x2, 0x2, 0x2, 0x2, 0x2, 0x2, 0x9, 0x9, 0x9, 0x9, 0x2, 0x2, 0x2, 0x2, 0x2,
0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0x9, 0x9, 0x9, 0x9, 0xa, 0xa, 0xa, 0xa, 0xa,
0xa, 0xa, 0xa, 0xa, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0xa, 0xa,
0xa, 0xa, 0xa, 0xa, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0xa, 0xa,
0xa, 0xa, 0xa, 0xa, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0xa, 0xa,
0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0x9, 0x9, 0x9, 0x9, 0xa, 0xa, 0xa, 0xa, 0xa
};

uint8_t show_tile_data_1dd8[16 * 16] = {
0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0x9, 0x9, 0x9, 0x9, 0xa, 0xa, 0xa, 0xa, 0xa,
0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa,
0xf, 0x9, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf,
0xf, 0x9, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf, 0xf,
...
uint8_t show_tile_data_1dc8x[16 * 16] = {
...
DRIVER_INIT_MEMBER(cps_state, forgottna)
{
	...
	show_tile_data(0x1dc8);
	show_tile_data(0x1dd8);

	// 1dc8 and 1dd8  red -> yellow
	put_tile_data(0x1dc8, show_tile_data_1dc8);
	put_tile_data(0x1dd8, show_tile_data_1dd8);
...
DRIVER_INIT_MEMBER(cps_state, sf2hf)
{
	...
	// tiles 16x16 ACED - ground tile air force
}
