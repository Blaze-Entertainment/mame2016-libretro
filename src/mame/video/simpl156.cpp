...
void simpl156_state::video_start()
{
	...
	{
		m_pf1_rowscroll[i] = 0x0000;
		m_pf2_rowscroll[i] = 0x0000;
	}
...
UINT32 simpl156_state::screen_update_simpl156(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect)
{
	...
	m_sprgen->draw_sprites(bitmap, cliprect, m_spriteram, 0xa00/2); // 0x1400/4 seems right for charlien (doesn't initialize any more RAM, so will draw a garbage 0 with more)
	return 0;
}
