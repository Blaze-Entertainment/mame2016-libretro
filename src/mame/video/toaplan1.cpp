		...
		case 0x3000:
		{
			...
			if (pc == 0x4c4)
			{
				...
				if (vram_offset & 1)
				{
					...
					{
						//UINT8 table[] = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x00, 0x01, 0x02, 0x03 }; // 0x04, 0x05, 0x06, 0x07, 0x08, 0x09
						UINT8 table[] = { 0x2d+0x2, 0x2d+0x2, 0x2d+0x2, 0x2d+0x2, 0x2d+0x2, 0x10, 0x1D+0x7, 0x18+0x7, 0x0a+0x7, 0x19+0x7, 0x15+0x7, 0x0a+0x7, 0x17+0x7, 0x2d+0x2, 0x01, 0x09, 0x08, 0x08, 0x2d+0x2, 0x2d+0x2, 0x2d+0x2, 0x2d+0x2, 0x2d+0x2,0x2d+0x2, };

						int offsetx = a0 - 0x2f3d;

						data = table[offsetx]+0x3030;
					}
				}
