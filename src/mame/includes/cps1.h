...
public:
	...
	DECLARE_DRIVER_INIT(nineteen);
	DECLARE_READ16_MEMBER(cps2_1944_skip_r);
	DECLARE_READ16_MEMBER(cps2_1944_skip2_r);
	...
	DECLARE_READ16_MEMBER(mercs_skip3_r);
	DECLARE_READ16_MEMBER(mercs_skip4_r);
